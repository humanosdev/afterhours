...
export default function ProfilePageSkeleton() {
  return (
    <div className="flex min-h-[100dvh] w-full flex-col bg-primary text-white">
      <div
        className={`${APP_CONTENT_MAX_CLASS} flex flex-1 flex-col px-4 ${APP_PAGE_TAIL_PADDING_CLASS} ${APP_PAGE_TOP_PADDING_CLASS} sm:px-5`}
      >

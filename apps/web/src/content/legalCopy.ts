...
const { appName, supportEmail, contactEmail, partnershipsEmail, minimumAge, termsVersion, privacyVersion } =
  appConfig;
...
export const termsLastUpdated = termsVersion;
export const privacyLastUpdated = privacyVersion;
...
export const privacySections: LegalSection[] = [
  ...
  },
  {
    heading: "Controls",
    paragraphs: [
      `You can edit your profile, block users, and manage notification preferences in the app. For support requests, contact ${supportEmail}. For general questions about this policy, contact ${contactEmail}.`,
    ],
  },
];

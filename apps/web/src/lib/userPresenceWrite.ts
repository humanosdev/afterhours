...
export async function upsertUserPresenceLatLng(
  ...
  /** No venue list — cannot run FSM; never preserve a stale `venue_id` on ping. */
...
export async function clearUserPresenceOnSignOut(supabase: SupabaseClient, userId: string) {

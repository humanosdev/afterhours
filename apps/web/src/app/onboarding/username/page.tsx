  ...
  return (
    <AuthScreenShell marketingScroll className="transition-colors">
      <div className="mb-6 flex items-center gap-2 border-b border-white/[0.08] pb-3">
        <SubpageBackButton onBack={() => navigateBack(router, "/onboarding")} />
        <h1 className="min-w-0 flex-1 text-[1.25rem] font-bold tracking-tight">Choose a username</h1>
      </div>
      <p className="text-sm text-text-secondary">This is how other people will find you.</p>

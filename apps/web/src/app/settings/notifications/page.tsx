...
export default function NotificationSettingsPage() {
  ...
  const goBackSafe = () => navigateBack(router, "/settings");
    ...
    <AuthScreenShell className={`text-white ${APP_TAB_BOTTOM_PADDING_CLASS}`}>
      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="rounded-xl border border-white/[0.08] bg-white/[0.04] p-4">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            <input
              ...
              className="rounded-xl border border-white/10 bg-primary/20 p-2 text-sm outline-none"
            />
            <input
              type="time"
              value={quietEnd}
        ...
        <button
          ...
          className="w-full rounded-xl bg-white px-4 py-3 text-sm font-semibold text-black shadow-[0_0_24px_rgba(59,102,255,0.15)] disabled:opacity-45"
        >

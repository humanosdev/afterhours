const withPWA = require("next-pwa")({
  ...
  runtimeCaching: [
    ...
    {
      urlPattern: /^https?:\/\/[^/]+\/(?:intencity-splash-lockup|icon-192|icon-512|apple-touch-icon)\.png$/i,
      handler: "NetworkFirst",
      options: {
        cacheName: "ah-brand-lockup",
...
const nextConfig = {
  ...
  async headers() {
    const brand = [
      {
        source: "/intencity-splash-lockup.png",
    ...
    if (process.env.NODE_ENV !== "development") return brand;
    return [
      ...brand,
      {
